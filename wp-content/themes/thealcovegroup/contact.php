      ...
      <div class="row contact-content">
        <div class="small-12 medium-6 columns office-details-col">
          ...
          <div class="lined-header-lockup">
            ...
            <h3><a href="tel:<?php echo the_field( 'phone_number' ); ?>" class="link-no-border"><?php the_field( 'phone_number' ); ?></a></h3>
          </div>
          <?php endif; ?>
          ...
          <div class="lined-header-lockup">
            ...
            <h3><a href="tel:<?php echo the_field( 'fax_number' ); ?>" class="link-no-border"><?php the_field( 'fax_number' ); ?></a></h3>
          </div>
          <?php endif; ?>
