...
class PyreThemeFramework {
	...
	public function default_options()
	{
		...
		add_option('pyre_footer_left', 'Copyright &copy; 2011 - Alcove Group. All rights reserved.');
		...
		add_option('pyre_homepage_style', 'grid');
	}
	...
	{
		$object = add_object_page('Theme Options', $this->theme_name, 'manage_options', 'pyre_framework', array($this, 'options_panel'), get_bloginfo('template_directory') . '/_admin/views/theme_options/images/themeoptions-icon.png');
	...
	{
		wp_enqueue_style($this->theme_name, get_bloginfo('template_url').'/_admin/views/theme_options/style.css', '', '1');
		
		wp_enqueue_script('jquery');
		wp_enqueue_script('ajaxupload', get_bloginfo('template_url').'/_admin/views/theme_options/js/ajaxupload.js');
		wp_enqueue_script('color-picker', get_bloginfo('template_url').'/_admin/views/theme_options/js/colorpicker.js');
	}
	...
	public function reset_fields()
	{
		...
		update_option('pyre_footer_left', 'Copyright &copy; 2011 - Alcove Group. All rights reserved.');
		...
		update_option('pyre_homepage_style', 'grid');
...
$pyre = new PyreThemeFramework('AG Admin');