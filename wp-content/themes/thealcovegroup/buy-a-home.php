        ...
        <div class="hero-overlay reverse">
          ...
          <div class="row hero-form form-button-right">
            <div class="small-12 small-centered medium-10 large-6 columns"> <!-- Start form column -->
              <!-- The form itself -->
                <form id="buy-a-home-form" class="row form-and-blurb" action="" method="post" data-abide onsubmit="event.preventDefault(); formSubmission(event);">
                  <input type="checkbox" name="Submitted Buy A Home Form" value="Submitted Buy A Home Form" checked style="display: none;" />
                  <div class="row">
