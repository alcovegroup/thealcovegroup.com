...
class SimplyRetsApiHelper {
    ...
    */
    public static function srRequestUrlBuilder( $params ) {
        ...
        if( is_array( $params ) ) {
            $thesample = $_GET['sample'];
            if(isset($thesample) && !empty($thesample)) {
                $params['maxprice'] = $thesample;
            }
...
HTML;
    ...
    public static function srResidentialDetailsGenerator( $listing ) {
        ...
        */
        ...
        $price = SimplyRetsApiHelper::srDetailsTable($listing_price_USD, "");
        // type
        ...
        $bedrooms = SimplyRetsApiHelper::srDetailsTable($listing_bedrooms, "");
        // full baths
        $listing_bathsFull = $listing->property->bathsFull;
        $bathsFull = SimplyRetsApiHelper::srDetailsTable($listing_bathsFull, "");
        // half baths
        ...
        $fireplaces = SimplyRetsApiHelper::srDetailsTable($listing_fireplaces, "");
        // Long
        ...
        $geo_county = SimplyRetsApiHelper::srDetailsTable($listing_county, "");
        // County
        ...
        $postal_code = SimplyRetsApiHelper::srDetailsTable($listing_postal_code, "");

        $listing_country = $listing->address->country;
        $country = SimplyRetsApiHelper::srDetailsTable($listing_country, "");

        $listing_address = $listing->address->full;
        $address = SimplyRetsApiHelper::srDetailsTable($listing_address, "");

        $listing_city = $listing->address->city;
        $city = SimplyRetsApiHelper::srDetailsTable($listing_city, "");

        $listing_cross_street = $listing->address->crossStreet;
        $cross_street = SimplyRetsApiHelper::srDetailsTable($listing_cross_street, "");

        $listing_state = $listing->address->state;
        $state = SimplyRetsApiHelper::srDetailsTable($listing_state, "");
...
HTML;
        ...
        $bedsMarkup  = SimplyRetsApiHelper::resultDataColumnMarkup($bedrooms, '');
        $bathsMarkup = SimplyRetsApiHelper::resultDataColumnMarkup($bathsFull, '');
        ...
        // school data
        $listing_school_district = $listing->school->district;
        $school_district = SimplyRetsApiHelper::srDetailsTable($listing_school_district, "");
        // elementary school
        $listing_elementary = $listing->school->elementarySchool;
        $school_elementary = SimplyRetsApiHelper::srDetailsTable($listing_elementary, "");
        // middle school
        $listing_middle_school = $listing->school->middleSchool;
        $school_middle = SimplyRetsApiHelper::srDetailsTable($listing_middle_school, "");
        // high school
        $listing_high_school = $listing->school->highSchool;
        $school_high = SimplyRetsApiHelper::srDetailsTable($listing_high_school, "");
	...
	<div class="additional-details">
        ...
        <?php if ( $listing_heating ):
            $details_table_markup .='
              <tr>
                <td>Heating &amp; Cooling</td>
                <td>'.$listing_heating.'</td>
              </tr>';
        endif; ?>
