            ...
            <table class="line-section-table">
                <tr>
                    <td class="table-left-header">
                        ...
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php $listing_url; ?>&title=<?php echo the_title(); ?>&summary=<?php echo get_the_content() ?>&source=<?php echo get_site_url(); ?>" target="_blank">
